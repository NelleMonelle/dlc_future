...
function Dummy:init()
    ...
    self.check = {"AT 14 DF 2\n* Corruption at its core.", "The more time passes,[wait:5] the more you feel it tingling in your SOUL."}

    -- Text randomly displayed at the bottom of the screen each turn
    self.text = {
        "* Something foams at Creature β's... Mouth?",
        "* Creature β stares straight into your SOUL.",
...
function Dummy:getEncounterText()
	if self.weakspot then
		return "* Creature β's weak spot has been revealed! It's defense dropped dramatically!"
	else
